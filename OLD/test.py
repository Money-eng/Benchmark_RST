...
if __name__ == "__main__":
    ...
    mtg_gt, mtg_pred = process_batch(
        ...
        jar_path=config["rst"]["jar_path"] if config["rst"].get(
            "jar_path") else "/home/loai/Documents/code/RSMLExtraction/RootSystemTracker/target/rootsystemtracker-1.6.1-jar-with-dependencies.jar"
    )
