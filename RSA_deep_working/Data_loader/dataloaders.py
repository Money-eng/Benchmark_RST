...
def create_dataloader(base_directory: str,
    ...
    val_loader_series = DataLoader(
        # loader that loads all the images in a series at a time -> same images as the val_loader but load the whole serie (in order) at once
