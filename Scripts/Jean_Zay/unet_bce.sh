...
python3 ./RSA_deep_working/Models/main_optuna.py --config "./RSA_deep_working/Models/configs/unet_bce.yml" > /lustre/fswork/projects/rech/vey/unq35lq/log/log_unet_bce.log 2>&1
