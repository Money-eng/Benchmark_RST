...
def main() -> None:
    ...
    evaluator = ReconstructionEvaluator(
        ...
        pred_val_folders=[os.path.join(PRED_VAL_FOLDERS, folder) for folder in pred_val_folders],
    ...
    if gt_test_folders:
        ...
        viewer = RootGraphViewer.from_rsml(gt_expertized, gt_before, prediction, background=back_ground_image)
        viewer.show()
